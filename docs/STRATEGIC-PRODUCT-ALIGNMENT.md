...
| **5.7** Consultative recommendation | **Partial** | **Pre–Phase 6:** regras camada 1 (`recommendation_runs`, feedback, histórico, UI no cliente, `sort=propensity_desc`). **Still:** IA generativa, matriz parametrizável avançada → **Phase 6+** |
